<%-- 
    Document   : contact
    Created on : 2 May 2024, 4:37:05 pm
          ...
          <div class="col-md-4">
            <div class="left-content">
              ...
              <ul class="social-icons">
                <li><a href="https://www.facebook.com/scented.ari?mibextid=ZbWKwl"><i class="fa fa-facebook"></i></a></li>
                <li><a href="https//www.instagram.com/scented.ari?igsh=MW15dmRxdTg3NTRnOA"><i class="fa fa-instagram"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
