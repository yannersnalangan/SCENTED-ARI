<%-- 
    Document   : homepage
    Created on : 2 May 2024, 4:34:46 pm
  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="homepage.jsp"><h2>Scented by <em>Ari</em></h2></a>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              <h2>Latest Scents</h2>
              <a href="products.jsp">view all products <i class="fa fa-angle-right"></i></a>
            </div>
          </div>
          <div class="col-md-4">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="right-image">
              <img src="assets/images/home_ag.jpg" alt="">
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12">
            <div class="inner-content">
              <div class="row">
                ...
                <div class="col-md-4">
                  <a href="products.jsp" class="filled-button">Purchase Now</a>
                </div>
              </div>
            </div>
          </div>
